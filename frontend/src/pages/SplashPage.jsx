	...
	return (
		<div className="splash">
			<div className="splash-card">
				...
				<p
					className={`splash-quote ${visible ? "splash-quote--visible" : "splash-quote--hidden"}`}
				>
					{motivations[index]}
				</p>

				<div className="splash-actions">
					<Link to="/login" className="btn-primary splash-btn">
						Sign In
					</Link>
					<Link to="/login?mode=signup" className="splash-link">
						Create Account
					</Link>
				</div>
			</div>
