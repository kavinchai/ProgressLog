...
export default function ClaudeSetup() {
	...
	async function handleGenerate() {
		...
		try {
			...
			console.warn("handleGenerate failed:", err);
		} finally {
	...
	return (
		<div className="claude-setup-page">
			<button
				className="btn btn-sm claude-setup-back"
			...
			<div className="claude-setup-card">
				...
				<p className="claude-setup-p">
					Generate an API key to create your personal MCP URL. Keep it secret —
					it gives full access to your account data.
				</p>
				...
				{apiKeyLoading ? (
					...
					<div className="claude-setup-key-section">
						...
						<div className="claude-setup-field-label" style={{ marginTop: 12 }}>
							Your MCP URL
						</div>
						<div className="claude-setup-copy-row">
							<input
						...
						<p className="claude-setup-hint">
							Tap the field to select, or use Copy URL — paste it into Claude in
							the next step.
						</p>
					</div>
				) : (
			...
			<div className="claude-setup-card">
				...
				<ol className="claude-setup-ol">
					<li>
						Go to <strong>claude.ai</strong> and open{" "}
					...
					<li>
						Give it a name like <strong>ProgressLog</strong>
					</li>
			...
			<div className="claude-setup-card">
				...
				<p className="claude-setup-p">
					For the Mac or Windows desktop app, edit the config file once.
				</p>
				<ol className="claude-setup-ol">
					<li>
						Open the config file:
						<div className="claude-setup-code">
							<span className="claude-setup-comment">Windows: </span>
							%APPDATA%\Claude\claude_desktop_config.json
							<br />
							<span className="claude-setup-comment">Mac: </span>
							~/Library/Application Support/Claude/claude_desktop_config.json
						</div>
					</li>
					<li>
						Add or merge this block, replacing the URL with your MCP URL from
						Step 1:
  ...
  "mcpServers": {
    "progresslog": {
      "url": "YOUR_MCP_URL_FROM_STEP_1"
					...
					<li>
						Save the file and <strong>fully quit and reopen</strong> Claude
						Desktop
					</li>
			...
			<div className="claude-setup-card">
				...
				<p className="claude-setup-p">
					Add the server once with a single command and it's available in all
					Claude Code sessions.
				</p>
				<ol className="claude-setup-ol">
					<li>
						Run this in your terminal, replacing the URL with your MCP URL from
						Step 1:
						<div className="claude-setup-code">
							claude mcp add progresslog --transport http
							"YOUR_MCP_URL_FROM_STEP_1"
						</div>
					</li>
					<li>
						That's it — the tools are now available globally in Claude Code
					</li>
					<li>
						Or scope it to one project by adding a <code>.mcp.json</code> file
						at the project root:
						<pre className="claude-setup-code">{`{
  "mcpServers": {
    "progresslog": {
      ...
      "url": "YOUR_MCP_URL_FROM_STEP_1"
			...
			<div className="claude-setup-card">
				...
				<ul className="claude-setup-list">
					<li>
						<strong>Tools not appearing in Desktop:</strong> Make sure you fully
						quit and reopened Claude Desktop after editing the config
					</li>
					<li>
						<strong>401 Unauthorized:</strong> Your API key may be invalid —
						regenerate it above
					</li>
					<li>
						<strong>Data going to the wrong account:</strong> Each MCP URL is
						tied to one account — make sure you used your own URL from Step 1
					</li>
				</ul>
			</div>
		</div>
