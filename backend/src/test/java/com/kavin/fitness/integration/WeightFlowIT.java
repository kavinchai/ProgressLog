...
/**
 * A user logs weight entries, reads them back sorted by date, deletes one, and verifies another
 * user can't see or delete them.
 */
class WeightFlowIT extends IntegrationTestBase {
    ...
    void otherUser_cannotDeleteWeight() throws Exception {
        ...
        mockMvc.perform(get("/api/weight").header("Authorization", "Bearer " + tokenB))
